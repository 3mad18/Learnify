  ...
  return (
    <div className="space-y-8">
      {questions.map((q, idx) => (
        <div
          key={idx}
          className="bg-gray-800 rounded-lg border border-gray-700 p-4 hover:border-cyan-600 transition"
        >
              ...
              <div className="space-y-3">
                {q.pairs && q.pairs.map((pair, pairIdx) => (
                  <div key={pairIdx} className="flex gap-2 items-center">
                    <input
                      type="text"
                      className="input input-bordered bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500 flex-1"
          ...
          <div className="flex items-center gap-4">
            ...
            <input
              type="number"
              min={1}
              className="input input-bordered bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500 w-24"
              value={q.score}
